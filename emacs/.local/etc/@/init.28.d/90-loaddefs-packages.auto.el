...
(fn &optional ARG)" t nil)(autoload 'vertico-directory-enter "vertico-directory" "Enter directory or exit completion with current candidate.
Exit with current input if prefix ARG is given.

(fn &optional ARG)" t nil)(autoload 'vertico-directory-up "vertico-directory" "Delete N names before point.
...
the first target at point." t nil)(defvar marginalia-mode nil "Non-nil if Marginalia mode is enabled.
...
(fn &optional ARG)" t nil)(autoload 'osx-trash-setup "osx-trash" "Provide trash support for OS X.
...
(fn PATH &optional IN-EMACS LINE SEARCH)" nil nil)(autoload 'org-open-at-point-global "org" "Follow a link or a timestamp like Org mode does.
...
support cURL transport." t nil)(autoload 'org-mac-link-get-link "org-mac-link" "Prompt for an application to grab a link from.
When done, go grab the link, and insert it at point. If a region
is active, that will be the link's description.

(fn &optional BEG END)" t nil)(autoload 'org-mac-link-firefox-get-frontmost-url "org-mac-link" "Get the link to the frontmost window of the Firefox.app." t nil)(autoload 'org-mac-link-firefox-insert-frontmost-url "org-mac-link" "Insert the link to the frontmost window of the Firefox.app." t nil)(autoload 'org-mac-link-vimperator-get-frontmost-url "org-mac-link" "Get the link to the frontmost window of the Firefox.app with Vimperator." t nil)(autoload 'org-mac-link-vimperator-insert-frontmost-url "org-mac-link" "Insert the link to the frontmost window of the Firefox.app with Vimperator." t nil)(autoload 'org-mac-link-chrome-get-frontmost-url "org-mac-link" "Get the link to the frontmost window of the Chrome.app." t nil)(autoload 'org-mac-link-chrome-insert-frontmost-url "org-mac-link" "Insert the link to the frontmost window of the Chrome.app." t nil)(autoload 'org-mac-link-brave-get-frontmost-url "org-mac-link" "Get the link to the frontmost window of the Brave.app." t nil)(autoload 'org-mac-link-brave-insert-frontmost-url "org-mac-link" "Insert the link to the frontmost window of the Brave.app." t nil)(autoload 'org-mac-link-safari-get-frontmost-url "org-mac-link" "Get the link to the frontmost window of the Safari.app." t nil)(autoload 'org-mac-link-safari-insert-frontmost-url "org-mac-link" "Insert the link to the frontmost window of the Safari.app." t nil)(autoload 'org-mac-link-together-get-selected "org-mac-link" "Get the links to selected items in the Together.app." t nil)(autoload 'org-mac-link-together-insert-selected "org-mac-link" "Insert the links to selected items in the Together.app." t nil)(autoload 'org-mac-link-finder-item-get-selected "org-mac-link" "Get the links to selected items in the Finder.app." t nil)(autoload 'org-mac-link-finder-insert-selected "org-mac-link" "Insert the links to selected items in the Finder.app." t nil)(autoload 'org-mac-link-addressbook-item-get-selected "org-mac-link" "Get the links to selected items in the addressbook." t nil)(autoload 'org-mac-link-addressbook-item-insert-selected "org-mac-link" "Insert the links to selected items in the addressbook." t nil)(autoload 'org-mac-link-skim-get-page "org-mac-link" "Get the link to the page in the Skim.app." t nil)(autoload 'org-mac-link-skim-insert-page "org-mac-link" "Insert the link to the page in the Skim.app." t nil)(autoload 'org-mac-link-acrobat-get-page "org-mac-link" "Get the link to the page in the Adobe Acrobat Pro.app." t nil)(autoload 'org-mac-link-acrobat-insert-page "org-mac-link" "Insert the link to the page in the Adobe Acrobat Pro.app." t nil)(autoload 'org-mac-link-outlook-message-get-links "org-mac-link" "Create links to selected or flagged messages in Microsoft Outlook.app.
...
(fn &optional SELECT-OR-FLAG)" t nil)(autoload 'org-mac-link-outlook-message-insert-selected "org-mac-link" "Insert a link to the messages currently selected in Microsoft Outlook.app.
This will use AppleScript to get the message-id and the subject
of the active mail in Microsoft Outlook.app and make a link out of it." t nil)(autoload 'org-mac-link-outlook-message-insert-flagged "org-mac-link" "Asks for an ORG-BUFFER and a heading within it, and replace message links.
...
(fn ORG-BUFFER ORG-HEADING)" t nil)(autoload 'org-mac-link-evernote-note-insert-selected "org-mac-link" "Insert a link to the notes currently selected in Evernote.app.
This will use AppleScript to get the note id and the title of the
note(s) in Evernote.app and make a link out of it/them." t nil)(autoload 'org-mac-link-devonthink-item-insert-selected "org-mac-link" "Insert a link to the item(s) currently selected in DEVONthink Pro Office.
This will use AppleScript to get the `uuid'(s) and the name(s) of the
selected items in DEVONthink Pro Office and make link(s) out of it/them." t nil)(autoload 'org-mac-link-mail-get-links "org-mac-link" "Create links to the messages currently selected or flagged in Mail.app.
This will use AppleScript to get the message-id and the subject of the
...
(fn &optional SELECT-OR-FLAG)" t nil)(autoload 'org-mac-link-mail-insert-selected "org-mac-link" "Insert a link to the messages currently selected in Mail.app.
This will use AppleScript to get the message-id and the subject of the
active mail in Mail.app and make a link out of it." t nil)(autoload 'org-mac-link-mail-insert-flagged "org-mac-link" "Asks for an ORG-BUFFER and a heading within it, and replace message links.
...
(fn ORG-BUFFER ORG-HEADING)" t nil)(autoload 'org-mac-link-qutebrowser-get-frontmost-url "org-mac-link" "Get the link to the frontmost window of the qutebrowser.app." t nil)(autoload 'org-mac-link-qutebrowser-insert-frontmost-url "org-mac-link" "Insert the link to the frontmost window of the qutebrowser.app." t nil)(autoload 'evil-org-mode "evil-org" "Buffer local minor mode for evil-org
