...
copies it to your clipboard, ready to be pasted into bug reports!" t)(autoload 'doom/toggle-profiler "~/.config/emacs/lisp/lib/debug" "Toggle the Emacs profiler. Run it again to see the profiling report." t)(defvar doom-docs-dir (file-name-concat doom-emacs-dir "docs/") "Where Doom's documentation files are stored. Must end with a slash.")(autoload 'doom-docs-mode "~/.config/emacs/lisp/lib/docs" "Hides metadata, tags, & drawers and activates all org-mode pretiffications.
...
(fn &optional FORCE-SAME-WORKSPACE)" t)(autoload '+vertico/embark-open-in-new-workspace "~/.config/emacs/modules/completion/vertico/autoload/workspaces" "Open X (a file) in a new workspace.

(fn X)" t)(autoload '+doom-dashboard/open "~/.config/emacs/modules/ui/doom-dashboard/autoload" "Switch to the dashboard in the current window, of the current FRAME.
...
(fn FN &rest ARGS)")(autoload '+evil-escape-a "~/.config/emacs/modules/editor/evil/autoload/advice" "Call `doom/escape' if `evil-force-normal-state' is called interactively.
...
(fn OV)")(autoload 'set-yas-minor-mode! "~/.config/emacs/modules/editor/snippets/autoload/settings.el" "Register minor MODES (one mode symbol or a list of them) with yasnippet so it
...
(fn TEMPLATE-UUID)" t)(autoload '+snippets/new "~/.config/emacs/modules/editor/snippets/autoload/snippets" "Create a new snippet in `+snippets-dir'." t)(autoload '+snippets/new-alias "~/.config/emacs/modules/editor/snippets/autoload/snippets" "Create an alias for a snippet with uuid TEMPLATE-UUID.
...
(fn MODE CHECKER NEXT &optional APPEND)")(put 'set-next-checker! 'doom-module '(:checkers . syntax))(autoload '+eval-display-results-in-popup "~/.config/emacs/modules/tools/eval/autoload/eval" "Display OUTPUT in a popup buffer.
...
(fn ARG)" t)(autoload '+macos/open-in-default-program "~/.config/emacs/modules/os/macos/autoload" nil t)(autoload '+macos/reveal-in-finder "~/.config/emacs/modules/os/macos/autoload" nil t)(autoload '+macos/reveal-project-in-finder "~/.config/emacs/modules/os/macos/autoload" nil t)(autoload '+macos/send-to-transmit "~/.config/emacs/modules/os/macos/autoload" nil t)(autoload '+macos/send-cwd-to-transmit "~/.config/emacs/modules/os/macos/autoload" nil t)(autoload '+macos/send-to-launchbar "~/.config/emacs/modules/os/macos/autoload" nil t)(autoload '+macos/send-project-to-launchbar "~/.config/emacs/modules/os/macos/autoload" nil t)(autoload '+macos/open-in-iterm "~/.config/emacs/modules/os/macos/autoload" nil t)(autoload '+macos/open-in-iterm-new-window "~/.config/emacs/modules/os/macos/autoload" nil t)(autoload '+emacs-lisp-eval "~/.config/emacs/modules/lang/emacs-lisp/autoload" "Evaluate a region and print it to the echo area (if one line long), otherwise
to a pop up buffer.
...
(fn &optional PARSE-START)")(autoload '+markdown-flyspell-word-p "~/.config/emacs/modules/lang/markdown/autoload" "Return t if `flyspell' should check word before point.
...
If it is an absolute path return `+org-capture-todo-file' verbatim.")(autoload '+org-capture-project-todo-file "~/.config/emacs/modules/lang/org/autoload/org-capture" "Find the nearest `+org-capture-todo-file' in a parent directory, otherwise,
...
(fn START END FN BRACKETED-P)")(autoload '+org-link--face-link-activate-face "~/.config/emacs/modules/lang/org/autoload/org-link" "

(fn START END FACE BRACKETED-P)")(autoload '+org-link--command-link-activate-command "~/.config/emacs/modules/lang/org/autoload/org-link" "
...
(fn MODULE-PATH ARG)")(autoload '+org-link--doom-module-link-face-fn "~/.config/emacs/modules/lang/org/autoload/org-link" "

(fn MODULE-PATH)")(autoload '+org-link--doom-module-link-activate-fn "~/.config/emacs/modules/lang/org/autoload/org-link" "
...
(fn START END PACKAGE BRACKETED-P)")(autoload '+org-link-follow-doom-package-fn "~/.config/emacs/modules/lang/org/autoload/org-link" "TODO
