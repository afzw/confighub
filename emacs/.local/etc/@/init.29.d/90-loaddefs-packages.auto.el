...
KEYMAP is selected interactively by mode in
`minor-mode-map-alist'." t)(autoload 'company-dict-refresh "company-dict" "Refresh all loaded dictionaries." t)(autoload 'company-dict "company-dict" "`company-mode' backend for user-provided dictionaries. Dictionary files are lazy
loaded.

(fn COMMAND &optional ARG &rest IGNORED)" t)(defvar vertico-mode nil "Non-nil if Vertico mode is enabled.
...
(fn DIRNAME)")(autoload 'consult-dir-jump-file "consult-dir" "Jump to file from the directory in the minibuffer prompt." t)(autoload 'consult-dir "consult-dir" "Choose a directory and act on it.
...
`consult-dir-sources', which can be customized." t)(autoload 'consult-flycheck "consult-flycheck" "Jump to flycheck error." t)(autoload 'consult-completion-in-region "consult" "Use minibuffer completion as the UI for `completion-at-point'.
...
(fn &optional ARG)" t)(autoload 'marginalia-cycle "marginalia" "Cycle between annotators in `marginalia-annotator-registry'." t)(autoload 'wgrep-setup "wgrep" "Setup wgrep preparation.")(add-hook 'grep-setup-hook 'wgrep-setup)(autoload 'doom-name-to-rgb "doom-themes" "Retrieves the hexidecimal string repesented the named COLOR (e.g. \"red\")
...
(fn ARG)" t)(defvar evil-goggles-mode nil "Non-nil if Evil-Goggles mode is enabled.
...
(fn &optional ARG)" t)(autoload 'persp-def-auto-persp "persp-mode" "
...
(fn &optional ARG)" t)(autoload 'evil-backward-arg "evil-args" "Move the cursor backward COUNT arguments.
...
(fn COUNT)" t)(autoload 'evilem--collect "evil-easymotion" "Repeatedly execute func, and collect the cursor positions into a list
...
(fn &optional MODES)" t)(autoload 'vimish-fold "vimish-fold" "Fold active region staring at BEG, ending at END.
...
(fn &optional ARG)" t)(autoload 'turn-on-evil-vimish-fold-mode "evil-vimish-fold")(autoload 'turn-off-evil-vimish-fold-mode "evil-vimish-fold" "Turn off `evil-vimish-fold-mode'." t)(autoload 'aya-create "auto-yasnippet" "Create a snippet from the text between BEG and END.
...
yasnippet directory.")(eval-after-load 'yasnippet (lambda nil (doom-snippets-initialize)))(autoload 'diredfl-mode "diredfl" "Enable additional font locking in `dired-mode'.
...
(fn DIR REGEXP)" t)(autoload 'undo-fu-disable-checkpoint "undo-fu" "Remove the undo-fu checkpoint, making all future actions unconstrained.
...
(fn &optional ARG)" t)(autoload 'vundo "vundo" "Display visual undo for the current buffer." t)(autoload 'browse-at-remote "browse-at-remote" "Browse the current file with `browse-url'." t)(autoload 'browse-at-remote-kill "browse-at-remote" "Add the URL of the current file to the kill ring.
...
(fn)" t)(dolist (pattern (list "/\\.gitignore\\'" "/info/exclude\\'" "/git/ignore\\'")) (add-to-list 'auto-mode-alist (cons pattern 'gitignore-mode)))(autoload 'flycheck-popup-tip-mode "flycheck-popup-tip" "A minor mode to show Flycheck error messages in a popup.
...
(fn RESPONSE)")(defvar pcre-mode nil "Non-nil if PCRE mode is enabled.
...
(fn &optional ARG)" t)(autoload 'hl-todo-mode "hl-todo" "Highlight TODO and similar keywords in comments and strings.
...
(fn KEYWORD)" t)(defvar magit-todos-mode nil "Non-nil if Magit-Todos mode is enabled.
...
(fn DIRECTORY)")(autoload 'osx-trash-setup "osx-trash" "Provide trash support for OS X.
...
(fn &optional ARG)" t)(autoload 'highlight-quoted-mode "highlight-quoted" "Highlight Lisp quotes and quoted symbols.
...
Add `flycheck-emacs-lisp-package' to `flycheck-checkers'." t)(autoload 'pkg-info-library-original-version "pkg-info" "Get the original version in the header of LIBRARY.
...
(fn LIBRARY &optional PACKAGE SHOW)" t)(autoload 'flycheck-manual "flycheck" "Open the Flycheck manual." t)(autoload 'flycheck-mode "flycheck" "Flycheck is a minor mode for on-the-fly syntax checking.
...
(fn SYMBOL DOCSTRING &rest PROPERTIES)" nil t)(function-put 'flycheck-define-checker 'lisp-indent-function 1)(function-put 'flycheck-define-checker 'doc-string-elt 2)(autoload 'flycheck-cask-setup "flycheck-cask" "Setup Cask integration for Flycheck.
...
(fn THEME)")(autoload 'org-annotate-file "org-annotate-file" "Visit `org-annotate-file-storage-file` and add a new annotation section.
...
(fn ORG-BUFFER ORG-HEADING)" t)(autoload 'org-mac-link-qutebrowser-get-frontmost-url "org-mac-link" "Get the link to the frontmost window of the qutebrowser.app." t)(autoload 'org-mac-link-qutebrowser-insert-frontmost-url "org-mac-link" "Insert the link to the frontmost window of the qutebrowser.app." t)(autoload 'goto-last-change "goto-chg" "Go to the point where the last edit was made in the current buffer.
...
(fn ARG)" t)(autoload 'evil-mode "evil" nil t)(autoload 'evil-org-mode "evil-org" "Buffer local minor mode for evil-org
...
(fn &optional ARG)" t)(autoload 'with-editor-export-editor "with-editor" "Teach subsequent commands to use current Emacs instance as editor.
...
(fn COMMAND &optional OUTPUT-BUFFER ERROR-BUFFER ENVVAR)" t)(autoload 'transient-insert-suffix "transient" "Insert a SUFFIX into PREFIX before LOC.
...
(fn PREFIX LOC)")(function-put 'transient-remove-suffix 'lisp-indent-function 'defun)(put 'git-commit-major-mode 'safe-local-variable (lambda (val) (memq val '(text-mode markdown-mode org-mode fundamental-mode git-commit-elisp-text-mode))))(autoload 'git-rebase-current-line "git-rebase" "Parse current line into a `git-rebase-action' instance.
...
(fn WORKTREE PATH)" t)(with-eval-after-load 'magit (define-key magit-mode-map [remap org-store-link] #'orgit-store-link))(autoload 'orgit-store-link "orgit" "Like `org-store-link' but store links to all selected commits, if any.
...
command to convert it." t)(autoload 'async-start-process "async" "Start the executable PROGRAM asynchronously named NAME.  See `async-start'.
...
(fn &optional ARG)" t)(defalias 'org-babel-execute-src-block:async 'ob-async-org-babel-execute-src-block)(autoload 'ob-async-org-babel-execute-src-block "ob-async" "Like org-babel-execute-src-block, but run asynchronously.
...
(fn &optional ORIG-FUN ARG INFO PARAMS)" t)(autoload 'dash-fontify-mode "dash" "Toggle fontification of Dash special variables.
...
This allows Dash symbols to be looked up with \\[info-lookup-symbol]." t)(autoload 'company-mode "company" "\"complete anything\"; is an in-buffer completion framework.
...
(fn COMMAND &optional ARG &rest IGNORE)" t)(autoload 'company-shell-rebuild-cache "company-shell" "Builds the cache of all completions found on the $PATH and all fish functions." t)(autoload 'company-fish-shell "company-shell" "Company backend for fish shell functions.
...
(fn COMMAND &optional ARG &rest IGNORED)" t)(autoload 'drag-stuff-up "drag-stuff" "Drag stuff ARG lines up.
...
(fn &optional ARG)" t)(autoload 'avy-transpose-lines-in-region "avy" "Transpose lines in the active region." t)(autoload 'link-hint-define-type "link-hint" "Add a new type of link called NAME to link-hint.el.
