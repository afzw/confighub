...
(fn &rest ARGS)" nil t)(autoload 'describe-personal-keybindings "bind-key" "Display all the personal keybindings defined by `bind-key'." t)(autoload 'use-package-autoload-keymap "use-package-bind-key" "Load PACKAGE and bind key sequence invoking this function to KEYMAP-SYMBOL.
...
with the specified `:load-path' the module cannot be found." t)(defvar auto-minor-mode-alist nil "Alist of filename patterns vs corresponding minor mode functions.
...
(fn &optional KEEP-MODE-IF-SAME)")(advice-add #'set-auto-mode :after #'auto-minor-mode-set)(defvar gcmh-mode nil "Non-nil if GCMH mode is enabled.
...
(fn &optional ARG)" t)(defvar explain-pause-mode nil "Non-nil if explain-pause mode is enabled.
...
(fn &optional FILE-SOCKET)" t)(autoload 'straight-remove-unused-repos "straight" "Remove unused repositories from the repos and build directories.
...
(fn &optional PACKAGE)" t)(defvar straight-x-pinned-packages nil "List of pinned packages.")(autoload 'all-the-icons-icon-for-dir "all-the-icons" "Get the formatted icon for DIR.
...
(fn &optional ARG FAMILY)" t)(autoload 'hide-mode-line-mode "hide-mode-line" "Minor mode to hide the mode-line in the current buffer.
...
Unless in `fundamental-mode' or `hide-mode-line-excluded-modes'.")(autoload 'turn-off-hide-mode-line-mode "hide-mode-line" "Turn off `hide-mode-line-mode'.")(autoload 'highlight-numbers-mode "highlight-numbers" "Minor mode for highlighting numeric literals in source code.
...
(fn &optional ARG)" t)(autoload 'rainbow-delimiters-mode "rainbow-delimiters" "Highlight nested parentheses, brackets, and braces according to their depth.
...
(fn &optional ARG)" t)(autoload 'rainbow-delimiters-mode-enable "rainbow-delimiters" "Enable `rainbow-delimiters-mode'.")(autoload 'rainbow-delimiters-mode-disable "rainbow-delimiters" "Disable `rainbow-delimiters-mode'.")(autoload 'restart-emacs-handle-command-line-args "restart-emacs" "Handle the --restart-emacs-desktop command line argument.
...
(fn &optional ARGS)" t)(autoload 'better-jumper-set-jump "better-jumper" "Set jump point at POS.
...
(fn &optional ARG)" t)(autoload 'dtrt-indent-mode "dtrt-indent" "Toggle dtrt-indent mode.
...
Setting this variable directly does not take effect;
use either \\[customize] or the function `dtrt-indent-mode'.")(autoload 'elisp-refs-function "elisp-refs" "Display all the references to function SYMBOL, in all loaded
elisp files.
...
(fn SYMBOL &optional PATH-PREFIX)" t)(autoload 'helpful-function "helpful" "Show help for function named SYMBOL.
...
(fn SYMBOL)" t)(autoload 'helpful-at-point "helpful" "Show help for the symbol at point." t)(autoload 'sp-cheat-sheet "smartparens" "Generate a cheat sheet of all the smartparens interactive functions.
...
(fn &optional ARG)" t)(autoload 'turn-on-show-smartparens-mode "smartparens" "Turn on `show-smartparens-mode'." t)(autoload 'turn-off-show-smartparens-mode "smartparens" "Turn off `show-smartparens-mode'." t)(autoload 'ws-butler-mode "ws-butler" "White space cleanup, without obtrusive white space removal.
...
(fn &optional ARG)" t)(autoload 'projectile-version "projectile" "Get the Projectile version as string.
...
(fn &optional ARG)" t)(define-obsolete-function-alias 'projectile-global-mode 'projectile-mode "1.0")(autoload 'general-define-key "general" "The primary key definition function provided by general.el.
...
(fn &optional SHORT-NAMES _)")(defvar which-key-mode nil "Non-nil if Which-Key mode is enabled.
...
KEYMAP is selected interactively by mode in
`minor-mode-map-alist'." t)(autoload 'drag-stuff-up "drag-stuff" "Drag stuff ARG lines up.
...
(fn &optional ARG)" t)(autoload 'link-hint-define-type "link-hint" "Add a new type of link called NAME to link-hint.el.
...
(fn COMMAND &optional ARG &rest IGNORED)" t)(autoload 'org-annotate-file "org-annotate-file" "Visit `org-annotate-file-storage-file` and add a new annotation section.
...
(fn STORAGE-FILE &optional ANNOTATED-BUFFER)")(autoload 'org-eldoc-load "org-eldoc" "Set up org-eldoc documentation function." t)(add-hook 'org-mode-hook #'org-eldoc-load)(autoload 'org-registry-show "org-registry" "Show Org files where there are links pointing to the current
buffer.
...
(fn &optional SUBTREEP VISIBLE-ONLY)" t)(autoload 'htmlize-buffer "htmlize" "Convert BUFFER to HTML, preserving colors and decorations.
...
(fn ARG &optional TARGET-DIRECTORY)" t)(autoload 'ox-clip-formatted-copy "ox-clip" "Export the selected region to HTML and copy it to the clipboard.
...
(fn &optional SCALE)" t)(autoload 'toc-org-enable "toc-org" "Enable toc-org in this buffer.")(autoload 'toc-org-mode "toc-org" "Toggle `toc-org' in this buffer.
...
(fn &optional ARG)" t)(autoload 'org-cliplink-retrieve-title "org-cliplink" "
...
note(s) in Evernote.app and make a link out of it/them." t)(autoload 'org-mac-link-devonthink-item-insert-selected "org-mac-link" "Insert a link to the item(s) currently selected in DEVONthink Pro Office.
This will use AppleScript to get the `uuid'(s) and the name(s) of the
selected items in DEVONthink Pro Office and make link(s) out of it/them." t)(autoload 'org-mac-link-mail-get-links "org-mac-link" "Create links to the messages currently selected or flagged in Mail.app.
This will use AppleScript to get the message-id and the subject of the
...
(fn ORG-BUFFER ORG-HEADING)" t)(autoload 'org-mac-link-qutebrowser-get-frontmost-url "org-mac-link" "Get the link to the frontmost window of the qutebrowser.app." t)(autoload 'org-mac-link-qutebrowser-insert-frontmost-url "org-mac-link" "Insert the link to the frontmost window of the qutebrowser.app." t)(autoload 'evil-org-mode "evil-org" "Buffer local minor mode for evil-org
...
(fn &optional ARG)" t)(with-eval-after-load 'magit (define-key magit-mode-map [remap org-store-link] #'orgit-store-link))(autoload 'orgit-store-link "orgit" "Like `org-store-link' but store links to all selected commits, if any.
...
(fn &optional ARG)")(autoload 'org-babel-execute-safely-maybe "ob-core")(autoload 'org-babel-execute-maybe "ob-core" nil t)(autoload 'org-babel-view-src-block-info "ob-core" "Display information on the current source block.
...
(fn &optional ARG INFO PARAMS EXECUTOR-TYPE)" t)(autoload 'org-babel-expand-src-block "ob-core" "Expand the current source code block.
Expand according to the source code block's header
arguments and pop open the results in a preview buffer.

(fn &optional ARG INFO PARAMS)" t)(autoload 'org-babel-check-src-block "ob-core" "Check for misspelled header arguments in the current code block." t)(autoload 'org-babel-insert-header-arg "ob-core" "Insert a header argument selecting from lists of common args and values.
...
(fn &optional ARG INFO)" t)(autoload 'org-babel-initiate-session "ob-core" "Initiate session for current code block.
If called with a prefix argument then resolve any variable
references in the header arguments and assign these variables in
the session.  Copy the body of the code block to the kill ring.

(fn &optional ARG INFO)" t)(autoload 'org-babel-switch-to-session "ob-core" "Switch to the session of the current code block.
...
(fn &optional INFO CONTEXT)" t)(autoload 'org-babel-hide-result-toggle-maybe "ob-core" "Toggle visibility of result at point." t)(autoload 'org-babel-goto-src-block-head "ob-core" "Go to the beginning of the current code block." t)(autoload 'org-babel-goto-named-src-block "ob-core" "Go to a named source-code block.

(fn NAME)" t)(autoload 'org-babel-goto-named-result "ob-core" "Go to a named result.
...
(fn POS)")(autoload 'org-element-cache-map "org-element" "Map all elements in current buffer with FUNC according to
...
(fn &optional RESTART NO-INSERT)" t)(autoload 'org-timer-change-times-in-region "org-timer" "Change all h:mm:ss time in region by a DELTA.
...
command to convert it." t)(defalias 'org-babel-execute-src-block:async 'ob-async-org-babel-execute-src-block)(autoload 'ob-async-org-babel-execute-src-block "ob-async" "Like org-babel-execute-src-block, but run asynchronously.
...
(fn &optional ORIG-FUN ARG INFO PARAMS)" t)(autoload 'markdown-mode "markdown-mode" "Major mode for editing Markdown files.
...
(fn &optional ARG)" t)(autoload 'markdown-toc-version "markdown-toc" "Markdown-toc version." t)(autoload 'markdown-toc-generate-toc "markdown-toc" "Generate a TOC for markdown file at current point.
...
(fn BEG END &optional DISPLAY-BUFFER)" t)(autoload 'evil-markdown-mode "evil-markdown" "Buffer local minor mode for evil-markdown
...
(fn THEME)")(autoload 'highlight-quoted-mode "highlight-quoted" "Highlight Lisp quotes and quoted symbols.
...
(fn &optional ARG)" t)(autoload 'macrostep-mode "macrostep" "Minor mode for inline expansion of macros in Emacs Lisp source buffers.
...
(fn &optional TOGGLE-SEPARATE-BUFFER)" t)(autoload 'macrostep-c-mode-hook "macrostep-c")(add-hook 'c-mode-hook #'macrostep-c-mode-hook)(autoload 'overseer-version "overseer" "Get the Overseer version as string.
...
(fn &optional ARG)" t)(autoload 'overseer-enable-mode "overseer")(dolist (hook '(emacs-lisp-mode-hook)) (add-hook hook 'overseer-enable-mode))(autoload 'elisp-def "elisp-def" "Go to the definition of the symbol at point." t)(autoload 'elisp-def-mode "elisp-def" "Minor mode for finding definitions with `elisp-def'.
...
(fn &optional ARG)" t)(autoload 'elisp-demos-advice-describe-function-1 "elisp-demos" "

(fn FUNCTION)")(autoload 'elisp-demos-advice-helpful-update "elisp-demos")(autoload 'elisp-demos-for-helpful "elisp-demos" "Find a demo for the current `helpful' buffer." t)(autoload 'package-lint-describe-symbol-history "package-lint" "Show the version history of SYM, if any.
...
whether or not warnings alone produce a non-zero exit code.")(autoload 'package-lint-looks-like-a-package-p "package-lint" "Return non-nil if the current buffer appears to be intended as a package.")(autoload 'flycheck-package-setup "flycheck-package" "Setup flycheck-package.
Add `flycheck-emacs-lisp-package' to `flycheck-checkers'." t)(autoload 'flycheck-cask-setup "flycheck-cask" "Setup Cask integration for Flycheck.
...
`flycheck-emacs-lisp-package-user-dir' accordingly.")(autoload 'buttercup-run-at-point "buttercup" "Run the buttercup suite at point." t)(autoload 'buttercup-run-discover "buttercup" "Discover and load test files, then run all defined suites.
...
non-nil value to enable trashing for file operations.")(defvar ns-auto-titlebar-mode nil "Non-nil if Ns-Auto-Titlebar mode is enabled.
...
(fn &optional ARG)" t)(defvar pcre-mode nil "Non-nil if PCRE mode is enabled.
...
(fn)" t)(defconst git-rebase-filename-regexp "/git-rebase-todo\\'")(define-obsolete-variable-alias 'global-magit-file-mode 'magit-define-global-key-bindings "Magit 3.0.0")(defvar magit-define-global-key-bindings t "Whether to bind some Magit commands in the global keymap.
...
(fn &optional PRINT-DEST)" t)(autoload 'magit-stage-file "magit-apply" "Stage all changes to FILE.
...
(fn FILE)" t)(autoload 'magit-unstage-all "magit-apply" "Remove all changes from the staging area." t)(put 'magit-auto-revert-mode 'globalized-minor-mode t)(defvar magit-auto-revert-mode (not (or global-auto-revert-mode noninteractive)) "Non-nil if Magit-Auto-Revert mode is enabled.
...
These sections can be expanded to show the respective commits.")(autoload 'magit-list-submodules "magit-submodule" "Display a list of the current repository's submodules." t)(autoload 'magit-subtree "magit-subtree" nil t)(autoload 'magit-subtree-import "magit-subtree" nil t)(autoload 'magit-subtree-export "magit-subtree" nil t)(autoload 'magit-subtree-add "magit-subtree" "Add REF from REPOSITORY as a new subtree at PREFIX.
...
(fn WORKTREE PATH)" t)(autoload 'async-start-process "async" "Start the executable PROGRAM asynchronously named NAME.  See `async-start'.
...
option is found.")(autoload 'request-response-header "request" "Fetch the values of RESPONSE header field named FIELD-NAME.
...
(fn RESPONSE)")(autoload 'quickrun-set-default "quickrun" "Set `key' as default key in programing language `lang'.
...
(fn &optional ARG)" t)(autoload 'anything-quickrun "quickrun" "Run quickrun with `anything'." t)(autoload 'helm-quickrun "quickrun" "Run quickrun with `helm'." t)(defvar eros-mode nil "Non-nil if Eros mode is enabled.
...
(fn &optional ARG)" t)(autoload 'flycheck-popup-tip-mode "flycheck-popup-tip" "A minor mode to show Flycheck error messages in a popup.
...
(fn &optional ARG)" t)(autoload 'browse-at-remote "browse-at-remote" "Browse the current file with `browse-url'." t)(autoload 'browse-at-remote-kill "browse-at-remote" "Add the URL of the current file to the kill ring.
...
Works like `browse-at-remote', but puts the address in the
kill ring instead of opening it with `browse-url'.")(autoload 'with-editor-export-editor "with-editor" "Teach subsequent commands to use current Emacs instance as editor.
...
(fn COMMAND &optional OUTPUT-BUFFER ERROR-BUFFER ENVVAR)" t)(put 'git-commit-major-mode 'safe-local-variable (lambda (val) (memq val '(text-mode markdown-mode org-mode fundamental-mode git-commit-elisp-text-mode))))(autoload 'transient-insert-suffix "transient" "Insert a SUFFIX into PREFIX before LOC.
...
(fn PREFIX LOC)")(function-put 'transient-remove-suffix 'lisp-indent-function 'defun)(autoload 'git-timemachine-toggle "git-timemachine" "Toggle git timemachine mode." t)(autoload 'git-timemachine "git-timemachine" "Enable git timemachine for file of current buffer." t)(autoload 'git-timemachine-switch-branch "git-timemachine" "Enable git timemachine for current buffer, switching to GIT-BRANCH.

(fn GIT-BRANCH)" t)(autoload 'gitattributes-mode "gitattributes-mode" "A major mode for editing .gitattributes files.
...
(fn)" t)(dolist (pattern (list "/\\.gitignore\\'" "/info/exclude\\'" "/git/ignore\\'")) (add-to-list 'auto-mode-alist (cons pattern 'gitignore-mode)))(autoload 'undo-fu-disable-checkpoint "undo-fu" "Remove the undo-fu checkpoint, making all future actions unconstrained.
...
(fn &optional ARG)" t)(autoload 'vundo "vundo" "Display visual undo for the current buffer." t)(autoload 'diredfl-mode "diredfl" "Enable additional font locking in `dired-mode'.
...
(fn &optional ARG)" t)(autoload 'dired-git-info-mode "dired-git-info" "Toggle git message info in current dired buffer.
...
automatically inside git repos.")(autoload 'dired-rsync "dired-rsync" "Asynchronously copy files in dired to `DEST' using rsync.
...
(fn DEST)" t)(autoload 'fd-dired "fd-dired" "Run `fd' and go into Dired mode on a buffer of the output.
...
(fn DIR REGEXP)" t)(autoload 'aya-create "auto-yasnippet" "Create a snippet from the text between BEG and END.
...
To save a snippet permanently, create an empty file and call this." t)(autoload 'aya-yank-snippet-from-history "auto-yasnippet" "Insert snippet from history at point." t)(autoload 'yas-minor-mode "yasnippet" "Toggle YASnippet mode.
...
(fn &optional ARG)" t)(autoload 'snippet-mode "yasnippet" "A mode for editing yasnippets" t nil)(autoload 'doom-snippets-remove-compiled-snippets "doom-snippets" "Delete all .yas-compiled-snippets.el files." t)(autoload 'doom-snippets-initialize "doom-snippets" "Add `doom-snippets-dir' to `yas-snippet-dirs', replacing the default
yasnippet directory.")(eval-after-load 'yasnippet (lambda nil (doom-snippets-initialize)))(autoload 'vimish-fold "vimish-fold" "Fold active region staring at BEG, ending at END.
...
(fn &optional ARG)" t)(autoload 'evil-vimish-fold-mode "evil-vimish-fold" "Evil-vimish-fold-mode.
...
(fn &optional ARG)" t)(autoload 'turn-on-evil-vimish-fold-mode "evil-vimish-fold")(autoload 'turn-off-evil-vimish-fold-mode "evil-vimish-fold" "Turn off `evil-vimish-fold-mode'." t)(autoload 'evil-backward-arg "evil-args" "Move the cursor backward COUNT arguments.
...
(fn COUNT)" t)(autoload 'avy-process "avy" "Select one of CANDIDATES using `avy-read'.
...
(fn &optional ARG)" t)(autoload 'avy-transpose-lines-in-region "avy" "Transpose lines in the active region." t)(autoload 'evilem--collect "evil-easymotion" "Repeatedly execute func, and collect the cursor positions into a list
...
(fn PREFIX)")(autoload 'er/expand-region "expand-region" "Increase selected region by semantic units.
...
If set to nil, always place the cursor at the beginning of the region.")(define-obsolete-variable-alias 'er/enable-subword-mode? 'expand-region-subword-enabled "2019-03-23")(defvar expand-region-subword-enabled nil "Whether expand-region should use subword expansions.")(autoload 'embrace-delete "embrace" nil t)(autoload 'embrace-change "embrace" nil t)(autoload 'embrace-add "embrace" nil t)(autoload 'embrace-commander "embrace" nil t)(autoload 'embrace-LaTeX-mode-hook "embrace")(autoload 'embrace-org-mode-hook "embrace")(autoload 'embrace-ruby-mode-hook "embrace")(autoload 'embrace-emacs-lisp-mode-hook "embrace")(autoload 'evil-embrace-enable-evil-surround-integration "evil-embrace" nil t)(autoload 'evil-embrace-disable-evil-surround-integration "evil-embrace" nil t)(defvar evil-escape-mode nil "Non-nil if Evil-Escape mode is enabled.
...
(fn &optional ARG)" t)(autoload 'evilnc-comment-or-uncomment-region-internal "evil-nerd-commenter" "Comment or uncomment region from START to END.
...
(fn &optional NUM)" t)(autoload 'evil-numbers/inc-at-pt "evil-numbers" nil t)(autoload 'evil-numbers/dec-at-pt "evil-numbers" nil t)(autoload 'evil-numbers/inc-at-pt-incremental "evil-numbers" nil t)(autoload 'evil-numbers/dec-at-pt-incremental "evil-numbers" nil t)(autoload 'evil-snipe-def "evil-snipe" "Define a N char snipe and bind it to FORWARD-KEY and BACKWARD-KEY.
...
(fn &optional ARG)" t)(autoload 'evil-surround-delete "evil-surround" "Delete the surrounding delimiters represented by CHAR.
...
(fn &optional ARG)" t)(autoload 'evil-textobj-anyblock-inner-block "evil-textobj-anyblock" nil t)(autoload 'evil-textobj-anyblock-a-block "evil-textobj-anyblock" nil t)(autoload 'evil-textobj-anyblock-forward-open-block-start "evil-textobj-anyblock" nil t)(autoload 'evil-textobj-anyblock-forward-open-block-end "evil-textobj-anyblock" nil t)(autoload 'evil-textobj-anyblock-forward-close-block-start "evil-textobj-anyblock" nil t)(autoload 'evil-textobj-anyblock-forward-close-block-end "evil-textobj-anyblock" nil t)(autoload 'evil-textobj-anyblock-backward-open-block-start "evil-textobj-anyblock" nil t)(autoload 'evil-textobj-anyblock-backward-open-block-end "evil-textobj-anyblock" nil t)(autoload 'evil-textobj-anyblock-backward-close-block-start "evil-textobj-anyblock" nil t)(autoload 'evil-textobj-anyblock-backward-close-block-end "evil-textobj-anyblock" nil t)(autoload 'evil-textobj-anyblock-forward-any-block-start "evil-textobj-anyblock" nil t)(autoload 'evil-textobj-anyblock-forward-any-block-end "evil-textobj-anyblock" nil t)(autoload 'evil-textobj-anyblock-backward-any-block-start "evil-textobj-anyblock" nil t)(autoload 'evil-textobj-anyblock-backward-any-block-end "evil-textobj-anyblock" nil t)(defvar evil-traces-mode nil "Non-nil if Evil-Traces mode is enabled.
...
(fn &optional ARG)" t)(autoload 'evil-visualstar-mode "evil-visualstar" "Minor mode for visual star selection.
...
(fn &optional ARG)" t)(autoload 'turn-on-evil-visualstar-mode "evil-visualstar" "Turns on visual star selection." t)(autoload 'turn-off-evil-visualstar-mode "evil-visualstar" "Turns off visual star selection." t)(autoload 'evil-quick-diff "evil-quick-diff" "Ediff two regions with evil motion." t)(autoload 'evil-quick-diff-cancel "evil-quick-diff-cancel" "Cancel evil-quick-diff and remove selections." t)(autoload 'evil-quick-diff-install "evil-quick-diff" "Setting evil-quick-diff key bindings.")(autoload 'annalist-record "annalist" "In the store for ANNALIST, TYPE, and LOCAL, record RECORD.
...
(fn ANNALIST TYPE &optional VIEW)")(autoload 'evil-collection-translate-minor-mode-key "evil-collection" "Translate keys in the keymap(s) corresponding to STATES and MODES.
...
(fn &optional MODES)" t)(autoload 'persp-def-auto-persp "persp-mode" "
...
(fn &optional ARG)" t)(autoload 'doom-modeline-set-main-modeline "doom-modeline" "Set main mode-line.
...
(fn ARG)" t)(autoload 'goto-last-change "goto-chg" "Go to the point where the last edit was made in the current buffer.
...
(fn ARG)" t)(autoload 'evil-mode "evil" nil t)(autoload 'hl-todo-mode "hl-todo" "Highlight TODO and similar keywords in comments and strings.
...
(fn KEYWORD)" t)(autoload 'doom-name-to-rgb "doom-themes" "Retrieves the hexidecimal string repesented the named COLOR (e.g. \"red\")
...
(fn &optional ARG)" t)(autoload 'orderless-filter "orderless" "Split STRING into components and find entries TABLE matching all.
...
(fn STR)")(autoload 'xref-find-backend "xref")(define-obsolete-function-alias 'xref-pop-marker-stack #'xref-go-back "29.1")(autoload 'xref-go-back "xref" "Go back to the previous position in xref history.
...
(fn REGEXP FILES)")(autoload 'project-current "project" "Return the project instance in DIRECTORY, defaulting to `default-directory'.
...
(fn &optional INCLUDE-ALL)" t)(autoload 'project-find-dir "project" "Start Dired in a directory inside the current project." t)(autoload 'project-dired "project" "Start Dired in the current project's root." t)(autoload 'project-vc-dir "project" "Run VC-Dir in the current project's root." t)(autoload 'project-shell "project" "Start an inferior shell in the current project's root directory.
...
(fn &optional ARG)" t)(autoload 'project-kill-buffers "project" "Kill the buffers belonging to the current project.
...
(fn DIR)" t)(autoload 'consult-dir-jump-file "consult-dir" "Jump to file from the directory in the minibuffer prompt." t)(autoload 'consult-dir "consult-dir" "Choose a directory and act on it.
...
`consult-dir-sources', which can be customized." t)(autoload 'pkg-info-library-original-version "pkg-info" "Get the original version in the header of LIBRARY.
...
(fn LIBRARY &optional PACKAGE SHOW)" t)(autoload 'dash-fontify-mode "dash" "Toggle fontification of Dash special variables.
...
This allows Dash symbols to be looked up with \\[info-lookup-symbol]." t)(autoload 'flycheck-manual "flycheck" "Open the Flycheck manual." t)(autoload 'flycheck-mode "flycheck" "Flycheck is a minor mode for on-the-fly syntax checking.
...
(fn SYMBOL DOCSTRING &rest PROPERTIES)" nil t)(function-put 'flycheck-define-checker 'lisp-indent-function 1)(function-put 'flycheck-define-checker 'doc-string-elt 2)(autoload 'consult-flycheck "consult-flycheck" "Jump to flycheck error." t)(autoload 'consult-completion-in-region "consult" "Use minibuffer completion as the UI for `completion-at-point'.
...
(fn FETCHER &optional ALIST)")(defun embark--record-this-command nil "Record command which opened the minibuffer.
...
the first target at point." t)(defvar marginalia-mode nil "Non-nil if Marginalia mode is enabled.
...
(fn &optional ARG)" t)(autoload 'marginalia-cycle "marginalia" "Cycle between annotators in `marginalia-annotator-registry'." t)(autoload 'wgrep-setup "wgrep" "Setup wgrep preparation.")(add-hook 'grep-setup-hook 'wgrep-setup)(autoload 'company-mode "company" "\"complete anything\"; is an in-buffer completion framework.
...
(fn COMMAND &optional ARG &rest IGNORE)" t)(autoload 'company-dict-refresh "company-dict" "Refresh all loaded dictionaries." t)(autoload 'company-dict "company-dict" "`company-mode' backend for user-provided dictionaries. Dictionary files are lazy
loaded.
