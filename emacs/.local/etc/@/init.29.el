...
]*<\\)*!DOCTYPE " . sgml-mode) ("ÐÏà¡±á" . doc-view-mode-maybe) ("%!PS" . ps-mode) ("# xmcd " . conf-unix-mode))) (set-default 'Info-directory-list '("/Users/fanzhiwen/.config/emacs/.local/straight/build-29.1/org/" "/usr/local/share/info" "/usr/local/share/info" "/usr/local/share/info/" "/usr/local/Cellar/emacs/29.1_1/share/info/emacs/" "/usr/local/share/info/")) (put 'doom-version 'major '3) (put 'doom-version 'minor '0) (put 'doom-version 'build '0) (put 'doom-version 'tag '"pre") (put 'doom-version 'ref '"5639ebf9420f6b4084a0a7226d42007ab1e1cb6c") (put 'doom-version 'branch '"master"))(defvar doom-real-buffer-functions '(doom-dired-buffer-p) "A list of predicate functions run to determine if a buffer is real, unlike
